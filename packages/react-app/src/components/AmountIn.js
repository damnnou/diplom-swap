...
const AmountIn = ({tokenIn, tokenOut}) => {
  ...
  return (
    <div className={styles.exchangeInputInside}>
      <button onClick={() => setShowList((prevState) => !prevState)} className='hover:bg-neutral-600 mx-auto my-auto ml-1 flex px-6 py-4 text-xl text-white w-[51%] h-[92%] rounded-lg'>
        ...
        <p className='text-neutral-400 text-base'><Balance /></p>
        </div>
      </button>
      {showList && (
        <div className={styles.chooseTokenMenu}>
          ...
          <div className='flex flex-col '>
            ...
            <input placeholder='Asset name, unit name or asset id' className='outline-none bg-neutral-900  py-4 px-16 rounded-xl focus:bg-neutral-700 mb-6' />
