const styles = {
  ...
  exchangeWindow: 'h-[110%] flex flex-col justify-start ml-[33%] mt-[9%] mb-0 w-[35%] ',
  ...
  chooseTokenMenu: 'z-100 h-fit flex flex-col sm:left-[1%] md:left-[9%] md:top-[25%] 2xl:top-[20%] sm:top-1/4 py-6 2xl:px-96 sm:px-12 xl:px-64 md:px-12 absolute sm:w-full md:w-[85%] min-h-[70%] bg-neutral-800 text-white rounded-lg',
